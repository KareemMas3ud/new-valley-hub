...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-&#t_$_@a10_-&ou*=owk0)eh3zl^6ds23+m%4)rrq9xbp2lt+y')
...
# CORS settings - Allow all origins (for localtunnel + Vercel)
